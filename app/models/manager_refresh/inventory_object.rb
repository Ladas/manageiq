module ManagerRefresh
  class InventoryObject
    ...
    delegate :manager_ref, :base_class_name, :model_class, :hash_index_with_keys_pre_save, :to => :inventory_collection
    delegate :[], :[]=, :to => :data
    ...
    def manager_uuid(keys = nil)
      keys ||= manager_ref
      hash_index_with_keys_pre_save(keys, data)
    end
