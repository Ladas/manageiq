class AddUniqueIndexAndTimestampToVms < ActiveRecord::Migration[5.0]
  def change
    ...
    add_index :disks, [:hardware_id, :device_name], :unique => true

    add_index :hosts, [:ems_id, :ems_ref], :unique => true
    add_index :ems_clusters, [:ems_id, :ems_ref], :unique => true
  end
end
